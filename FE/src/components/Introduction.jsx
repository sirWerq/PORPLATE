            ...
            >
                <div className='flex gap-10'>
                    <a href='https://github.com/sirWerq' target='_blank'>
                        <FaGithub className='text-black w-8 h-8 md:w-10 md:h-10 lg:w-16 lg:h-16 hover:text-black/70 dark:text-white dark:hover:text-slate-300' />
                    </a>
                    <a
                        href='https://www.instagram.com/rfqiags/'
                        target='_blank'
                    >
                        <FaInstagram className='text-black w-8 h-8 md:w-10 md:h-10 lg:w-16 lg:h-16 hover:text-black/70 dark:text-white dark:hover:text-slate-300' />
                    </a>
                    <a
                        href='https://www.linkedin.com/in/rifqi-alisba-garwita-sutrisno-612852241/'
                        target='_blank'
                    >
                        <FaLinkedin className='text-black w-8 h-8 md:w-10 md:h-10 lg:w-16 lg:h-16 hover:text-black/70 dark:text-white dark:hover:text-slate-300' />
                    </a>
                </div>
            </motion.div>
